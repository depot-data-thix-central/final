...
class _CourseCreatePageState extends ConsumerState<CourseCreatePage> {
  ...
  void initState() {
    ...
    if (widget.courseId != null) {
      ...
      final userName = user?.userMetadata?['full_name'] ?? user?.userMetadata?['name'];
      if (userName != null) {
  ...
  Future<void> _saveCourse() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
          content: Text('Erreur : $e'), backgroundColor: ThixPolicy.danger));
    } finally {
  ...
  InputDecoration _inputDeco(String label, {IconData? icon, String? hintText}) {
    return InputDecoration(
      labelText: label,
      hintText: hintText,
      labelStyle: const TextStyle(color: ThixPolicy.textSecondary, fontSize: 14),
                  ...
                  icon: _isLoading
                      ? const SizedBox(
                          ...
                          child: CircularProgressIndicator(
                              color: ThixPolicy.onBrand, strokeWidth: 2))
                      : const Icon(Icons.save_rounded, size: 18),
                  label: Text(_isLoading ? 'En cours...' : 'Enregistrer',
                        ...
                        child: _imageUrlController.text.isEmpty
                                ...
                                children: [
                                  if (_isUploadingImage)
                                    ...
                                    const Icon(Icons.add_photo_alternate_rounded,
                                        size: 42, color: ThixPolicy.primary),
                            ...
                            : Align(
                                ...
                                child: Padding(
                                  ...
                                  child: CircleAvatar(
                                    backgroundColor:
                                        ThixPolicy.inkDeep.withOpacity(0.7),
                                    radius: 18,
                                    child: const Icon(Icons.edit_rounded,
                                        color: ThixPolicy.onBrand, size: 18),
                                  ),
                                ),
                              ),
                      ),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          TextFormField(
                              ...
                              decoration: _inputDeco('Académie / Nom du formateur *',
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          DropdownButtonFormField<String>(
                              ...
                              decoration: _inputDeco('Niveau de difficulté',
                    ...
                    if (isNewCourse)
                      Container(
                          ...
                          child: const Column(
                            children: [
                              ...
                              Text(
                                  'Sauvegardez d\'abord le cours pour pouvoir y ajouter vos modules et leçons.',
                      ...
                      ..._modules.asMap().entries.map((entry) {
                        ...
                        return Container(
                            ...
                            child: ListTile(
                                contentPadding: const EdgeInsets.symmetric(
                                    horizontal: ThixPolicy.s16, vertical: 8),
